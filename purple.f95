...
program purple
   ...
   integer, parameter :: NR = 3, NL = 25, NS = 6, NT = 20, LIM = 262144
   integer :: i, j, n, fst, mdm, slw, idx, recno, eof
   character :: ch, flag
   ...
   close (7)
   ! Read it all at once since Perl has filtered it already.
   allocate (msg(n))
   read (*,2000,iostat=eof) (msg(i),i=1,n)
   i = 1
   j = 0
   do i = 1, n
      ch = msg(i)
